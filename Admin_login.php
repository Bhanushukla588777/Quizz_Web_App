    ...
    <head>
        ...
        <link href="css/bootstrap.css" rel="stylesheet">
         ...
         <style>
            ...
            .write {
                animation: 2s anim-write ease-out infinite;
                color:white;
              }
            ...
            .submit{
                ...
                font-weight: bold;
                margin-top: 50px;
                background: linear-gradient(to right,rgba(128,128,128,0.4),rgba(0,0,0,0.5),rgba(40,42,52,0.6),rgba(255,152,0,0.5));
            }
        </style>
        <script>
            function dateTime()
    ...
    <body onload="dateTime()">
        <div class="container-fluid homescreen">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <form action="validate.php" method="post" class="form-control mt-4">
                    <img src="adminpic.png" class="img1">
                        <div class="login-box mt-4">
                            <input type="text" placeholder="Admin_Id" name="admin_name" class="admin form-control"><br>
                            <input type="password" placeholder="password" name="password" class="admin form-control">
