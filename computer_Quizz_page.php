        ...
        <div class="container-fluid homescreen">
            ...
            <div class="row row2">
                <div class="col-sm-3 pt-3 text-light">
                    <h3 style="font-family: cursive;">Fundamental Of <b style="border-bottom: 2px solid white; color:yellow">Computer :</b></h3>
                </div>
			...
			<div class="row row2">
                ...
                <form action="computer_Connection_page.php" method="POST">
                    <h4>1. The brain of any Computer system is.</h4>
                    <input type="radio" id="python" name="answer1" value="a">
                    <label for="python"><b>ALU</b></label><br>
                    <input type="radio" id="van" name="answer1" value="b">
                    <label for="van"><b>CPU</b></label><br>
                    <input type="radio" id="tim" name="answer1" value="c">
                    <label for="tim"><b>Memory</b></label><br>
                    <input type="radio" id="lerdorf" name="answer1" value="d">
                    <label for="lerdorf"><b>Control Unit</b></label><br>

                    <h4 style="margin-top:20px;">2. Who is the father of Computer? </h4>
                    <input type="radio"  id="syntax" name="answer2" value="a">
                    <label for="syntax"><b>James Gosling</b></label><br>
                    <input type="radio"  id="syntax1" name="answer2" value="b">
                    <label for="syntax1"><b>Charles Babbage</b></label><br>
                    <input type="radio"  id="syntax2" name="answer2" value="c">
                    <label for="syntax2"><b>Dennis Ritchie</b></label><br>
                    <input type="radio"  id="syntax3" name="answer2" value="d">
                    <label for="syntax3"><b>Bjarne Stroustrup</b></label><br>

                   <h4 style="margin-top:20px;">3. What is the full form of CPU?</h4>
                   <input type="radio"  id="number" name="answer3" value="a">
                   <label for="number"><b>Computer Processing Unit</b></label><br>
                   <input type="radio"  id="number1" name="answer3" value="b">
                    <label for="number1"><b>Computer Principle Unit</b></label><br>
                    <input type="radio"  id="number2" name="answer3" value="c">
                   <label for="number2"><b>Central Processing Unit</b></label><br>
                   <input type="radio"  id="number3" name="answer3" value="d">
                   <label for="number3"><b>Control Processing Unit</b></label><br>

                   <h4 style="margin-top:20px;">4. ALU stands for</h4>
                   
                   <input type="radio"  id="code" name="answer4" value="a">
                   <label for="code"><b>Arithmetic Logic Unit</b></label><br>
                   <input type="radio"  id="code1" name="answer4" value="a">
                   <label for="code1"><b>Application Logic Unit</b></label><br>
                   <input type="radio"  id="code2" name="answer4" value="a">
                   <label for="code2"><b>Array Logic Unit</b></label><br>
                   <input type="radio"  id="code3" name="answer4" value="a">
                   <label for="code3"><b>None of these</b></label><br>

                   <h4 style="margin-top:20px;">5. Which of the following is not output device?</h4>
                   <input type="radio"  id="string" name="answer5" value="a">
                   <label for="string"><b>Printer</b></label><br>
                   <input type="radio"  id="string1" name="answer5" value="b">
                   <label for="string1"><b>VDU</b></label><br>
                   <input type="radio"  id="string1" name="answer5" value="b">
                   <label for="string1"><b>Scanner</b></label><br>
                   <input type="radio"  id="string1" name="answer5" value="b">
                   <label for="string1"><b>All</b></label><br>

                   <h4 style="margin-top:20px;">6. Which of the following is not input device?</h4>
                   
                   <input type="radio"  id="strip" name="answer6" value="a">
                   <label for="strip"><b>Touch Pad</b></label><br>
                   <input type="radio"  id="strip1" name="answer6" value="a">
                   <label for="strip1"><b>Mouse</b></label><br>
                   <input type="radio"  id="strip2" name="answer6" value="a">
                   <label for="strip2"><b>Printer</b></label><br>
                   <input type="radio"  id="strip3" name="answer6" value="a">
                   <label for="strip3"><b>None of these</b></label><br>

                   <h4 style="margin-top:20px;">7. _________ is Volatile Memory.</h4>
                   
                    <input type="radio"  id="error" name="answer7" value="a">
                    <label for="error"><b>ROM</b></label><br>
                    <input type="radio"  id="error1" name="answer7" value="b">
                    <label for="error1"><b>EPROME</b></label><br>
                    <input type="radio"  id="error2" name="answer7" value="c">
                    <label for="error2"><b>RAM</b></label><br>
                    <input type="radio"  id="error3" name="answer7" value="d">
                    <label for="error3"><b>None</b></label><br>

                    <h4 style="margin-top:20px;">8. Hardware can work without device driver</h4>
                    
                    <input type="radio"  id="value" name="answer8" value="a">
                    <label for="value"><b>True</b></label><br>
                    <input type="radio"  id="value1" name="answer8" value="b">
                    <label for="value1"><b>False</b></label><br>
                    

                    <h4 style="margin-top:20px;">9. Which of the following device can be used to directly image printed text.</h4>
                    <input type="radio"  id="block" name="answer9" value="a">
                    <label for="block"><b>OMR</b></label><br>
                    <input type="radio"  id="block1" name="answer9" value="b">
                    <label for="block1"><b>OCR</b></label><br>
                    <input type="radio"  id="block2" name="answer9" value="c">
                    <label for="block2"><b>MICR</b></label><br>
                    <input type="radio"  id="block3" name="answer9" value="d">
                    <label for="block3"><b>All of  above</b></label><br>

                    <h4 style="margin-top:20px;">10.Operating System is </h4>
                    <input type="radio"  id="function" name="answer10" value="a">
                    <label for="function"><b>Hardware</b></label><br>
                    <input type="radio"  id="function1" name="answer10" value="b">
                    <label for="function1"><b>Software which manage resources of the system</b></label><br>
                    <input type="radio"  id="function2" name="answer10" value="c">
                    <label for="function2"><b>Software which perform computation</b></label><br>
                    <input type="radio"  id="function3" name="answer10" value="d">
                    <label for="function3"><b>None of the Above</b></label><br><br><br>
