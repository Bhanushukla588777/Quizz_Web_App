    ...
    <head>
        ...
        <script>
            ...
            function closesession()
            {
                ...
                window.location.href ="python_Connection_page.php";
            }
        </script>
    </head>
    <body onload="Start()">
        <div class="container-fluid homescreen">
            ...
            <div class="row row2">
                <div class="col-sm-3 pt-3 text-light">
                    <h3 style="font-family: cursive;">Core <b style="color: yellow; border-bottom:2px solid white; margin-left:10px">PYTHON</b> :</h3>
                </div>
			...
			<div class="row row2">
                ...
                <form action="python_Connection_page.php" method="POST">
                    <h4>1. Who is a Inventor of Python?</h4>
                    ...
                    <h4>2. What is a correct syntax to output "Hello World" in Python?</h4>
                    <input type="radio"  id="syntax" name="answer2" value="a">
                    <label for="syntax"><b>print("Hello World")</b></label><br>
                    <input type="radio"  id="syntax1" name="answer2" value="b">
                    <label for="syntax1"><b>print(Hello World)</b></label><br>
                    <input type="radio"  id="syntax2" name="answer2" value="c">
                    <label for="syntax2"><b>echo("Hello World")</b></label><br>
                    <input type="radio"  id="syntax3" name="answer2" value="d">
                    <label for="syntax3"><b>echo(Hello World)</b></label><br>

                   <h4>3. How do you create a variable with the numeric value 5?</h4>
                   <input type="radio"  id="number" name="answer3" value="a">
                   <label for="number"><b>x = 5</b></label><br>
                   <input type="radio"  id="number1" name="answer3" value="b">
                    <label for="number1"><b>x = 5;</b></label><br>
                    <input type="radio"  id="number2" name="answer3" value="c">
                   <label for="number2"><b>x = int(5)</b></label><br>
                   <input type="radio"  id="number3" name="answer3" value="d">
                   <label for="number3"><b>All of the above</b></label><br>

                   <h4>4. What is the output of the following code?</h4>
                   <h5>for i in range(10,15,-1):<br/>
                        print(i)
                   </h5>
                   <input type="radio"  id="code" name="answer4" value="a">
                   <label for="code"><b>10, 11, 12, 13, 14</b></label><br>
                   <input type="radio"  id="code1" name="answer4" value="b">
                   <label for="code1"><b>10, 11, 12, 13, 14, 15</b></label><br>
                   <input type="radio"  id="code2" name="answer4" value="c">
                   <label for="code2"><b>11, 12, 13, 14</b></label><br>
                   <input type="radio"  id="code3" name="answer4" value="d">
                   <label for="code3"><b>10, 11, 12, 13</b></label><br>

                   <h4>5. A string is immutable in Python?</h4>
