<html>
        ...
        <link href="css/bootstrap.css" rel="stylesheet">
         ...
         <style>
			...
			.input_button{
				...
				font-family:Times New Roman;
				border-radius:25px;
				box-shadow:8px 0px 15px -5px green inset;
			}
        </style>
        <script>
            function dateTime()
    ...
    <body onload="dateTime()">
        <div class="container-fluid homescreen">
            ...
            <div class="row">
              <!--Contact_Us Form-->
				<div class="col-sm-12 bg-info px-5 py-3">
					<div class="row"  style="background:white; border-radius:8px;">
						<div class="col-sm-7">
							<img src="messagebox.png" class="messagebox">
						</div>
						<div class="col-sm-5">
							<form action="contactus_connection.php" method="POST">
								<h3 class="mt-5 text-center" style="font-family:Times New Roman">Get In Touch </h3>
								<input type="text" placeholder="Name" name="name" class="form-control mt-5 input_text" required>
								<input type="email" placeholder="Email" name="email" class="form-control mt-5 input_text" required>
								<input type="number" placeholder="Number" name="number" class="form-control mt-5 input_text" required>
								<textarea placeholder="Message" name="message" class="form-control mt-5 input_text"></textarea>
								<center>
									<input type="submit"  value="Send Mail" class="mt-5 form-control mb-5 input_button w-50">
								</center>
							</form>
						</div>
					</div>
