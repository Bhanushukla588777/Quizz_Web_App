        ...
        <div class="container-fluid homescreen">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 menu">
                    ...
                    <a href="signup.php"><button type="button" class="btn btn-light effect">Sign Up</button></a>
			...
			<div class="row mt-5 p-5">
				<div class="col-sm-5 a1">
					<center>
						<h1 style="margin-top:180px;"><b>Welcome To QuizHub</b></h1>
						<h5 class="mt-4">To keep connected with us please <br>Sign up with your personal info.</p>
						<input type="button" value="SIGN UP" class="signin_box mt-3">
					</center>
				</div>
				<div class="col-sm-7 a2">
					<center>
						<!--icons-->
						...
						<!--icons--->
							...
							<h3 style="font-family:Times New Roman; color:black; margin-top:50px;">Register here</p>
						<!--form part-->
						<form action="signup_connection.php" method="POST">
							<div class=" row box">
								...
								<div class="col-sm-11">
									<input type="text" placeholder="Full Name" name="name" class="input_box form-control" autofocus required>
								</div>
							</div><br>
							<div class=" row box">
								<div class="col-sm-1 pt-1">
								...
								<div class="col-sm-11">
									<input type="number" placeholder="Number" name="number" class=" input_box form-control" required>
								</div>
							</div><br>
							<div class=" row box">
								<div class="col-sm-1 pt-1">
								...
								<div class="col-sm-11">
									<input type="email" placeholder="Email" name="email" class="input_box form-control" required>
								</div>
							</div><br>
							<div class=" row box">
								<div class="col-sm-1 pt-1">
								...
								<div class="col-sm-11">
									<input type="password" placeholder="Password" name="password" class=" input_box form-control" required>
								</div>
							</div><br>
							<div class=" row box">
								<div class="col-sm-1 pt-1">
								...
								<div class="col-sm-11">
									<input type="password" placeholder="Confirm Password" name="confirm_password" class=" input_box form-control" required>
								</div>
							</div>
                                <input type="submit" value="REGISTER" class="signin_box">
						</form>
						<!---form part--->
					</center>
				</div>
